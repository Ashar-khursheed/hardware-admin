    ...
    <>
      <CheckoutCard icon={<RiMapPinLine />}>
        <div className="checkout-title">
          ...
          {values['consumer_id'] && <a className="d-flex align-items-center fw-bold" onClick={() => setModal(true)}><RiAddLine className="me-1"></RiAddLine>{t("add_new")}</a>}
        </div>
